...
uses
  Data.SqlExpr,SysUtils, classes, System.Rtti, System.TypInfo,
  System.Generics.Collections,UPaginate, UModel, Vcl.Clipbrd,
...
constructor TORMFramwork.Create(PConexao: TFDConnection);
begin
...
begin
    ...
    try
      ...
      raise Exception.Create('Erro: SQLQuery inválida !');
    end;
